...
var Sentry = (function (exports, globalThis) {
  ...
  function shouldShowBrowserExtensionError() {
    const windowWithMaybeExtension =
      typeof WINDOW$1.window !== 'undefined' && (WINDOW$1 );
  ...
  async function lazyLoadIntegration(
    ...
    const parent = WINDOW$1.document.body || WINDOW$1.document.head || (currentScript && currentScript.parentElement);
